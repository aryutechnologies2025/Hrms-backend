...
//     // 1️⃣ Fetch all project details by employeeId (clientName)
//     let projectIds;
//     let projectDetails;
//     if (employeeId) {
...
//     if (projectId) {
//       const projectObjectId = new mongoose.Types.ObjectId(projectId);
//       projectIds = projectIds.filter((p) => p.equals(projectObjectId));
//     }
...
//       // Lookup for assignedTo (employee)
//       {
//         $lookup: {
//           from: "employees",
//           localField: "assignedTo",
...
//       // Apply search term on populated fields
//       ...(searchTerm
//         ? [
//             {
//               $match: {
...
//     // 4️⃣ Count total tasks per status
//     const statusList = [
//       "todo",
//       "in-progress",
//       "in-review",
...
//       const tasks = await Task.aggregate(statusPipeline);
//       const countPipeline = [
//         ...pipeline,
//         { $match: { status } },
//         { $count: "count" },
...
//     // 5️⃣ Totals
//     const totalProjectCount = projectIds.length;
//     const totalUserTasks = Object.values(taskByStatus).reduce(
//       (acc, s) => acc + s.count,
//       0
//     );

//     const statusCounts = Object.fromEntries(
//       statusList.map((s) => [s, taskByStatus[s].count])
//     );
...
//         totalPages: Math.ceil(totalUserTasks / limitInt),
//       },
//       counts: {
//         totalProjectCount,
//         totalUserTasks,
